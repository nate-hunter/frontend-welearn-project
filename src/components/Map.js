...
class Map extends React.Component {
  render(){
    return(
      <div>
        <iframe width="100%" height="520" frameborder="0" src="https://savi.carto.com/u/nhunter1001/builder/95bf5e3a-6996-4b40-9441-e69cb2ea951f/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
        <p>---</p>
